...
{% include image.html url="/assets/images/fort-canning.jpg" description="The gate of Fort Canning" %}

{% include image.html url="/assets/images/battlebox-canning.jpg" description="The bunker at Fort Canning where the British surrendered to the Japanese" %}
...
{% include image.html url="/assets/images/lord-canning.jpg" description="Lord Canning, 1860 (source: Wikipedia)" %}
...
{% include image.html url="/assets/images/lady-canning.jpg" description="Painting of Lady Canning by H Hering in Calcutta, 1861 (source: Wikipedia)" %}
